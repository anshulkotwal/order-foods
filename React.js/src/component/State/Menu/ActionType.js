...
export const GET_ALL_MENU_ITEM_REQUEST = "GET_ALL_MENU_ITEM_REQUEST";
export const GET_ALL_MENU_ITEM_SUCCESS = "GET_ALL_MENU_ITEM_SUCCESS";
export const GET_ALL_MENU_ITEM_FAILURE = "GET_ALL_MENU_ITEM_FAILURE";
